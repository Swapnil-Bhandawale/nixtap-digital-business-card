const fs = require('fs');
let lines = fs.readFileSync('src/pages/app/Dashboard.jsx', 'utf8').split('\n');

const correctBlock = `          </motion.div>
...
// Remove lines 239 through 240 (inclusive) and insert correctBlock
lines.splice(239, 2, correctBlock);

fs.writeFileSync('src/pages/app/Dashboard.jsx', lines.join('\n'), 'utf8');
